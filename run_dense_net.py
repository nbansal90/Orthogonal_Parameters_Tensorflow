...
train_params_cifar = {
    ...
    'initial_weight_decay': 1e-8,
    'initial_ortho_decay':  1e-2,
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--ortho_decay', '-od', type=float, default=1e-2, metavar='',
        help='Orthogonal Weight decay for optimizer (default: %(default)s)')"""
    parser.add_argument(
